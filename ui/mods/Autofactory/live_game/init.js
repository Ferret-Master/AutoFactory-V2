...
var tAutoFactory = (function () {
    ...
    var	ANT = '/pa/units/land/tank_light_laser/tank_light_laser.json',
		...
		Bug_Unit_List = [BUG_ORBITAL_TRANSPORT,BEHEMOTH,CHOMPER,BUG_ORBITAL_FAB,SEEKER,SEEKER_VISION,BUG_ORBITAL_LASER,BUG_ORBITAL_RADAR,BUG_ORBITAL_RADAR_ADVANCED,BUG_FIGHTER,BUG_FIGHTER_ADVANCED,MEDUSA,STHENO,
		...
		Bug_String_List = ["BUG_ORBITAL_TRANSPORT","BEHEMOTH","CHOMPER","BUG_ORBITAL_FAB","SEEKER","SEEKER_VISION","BUG_ORBITAL_LASER","BUG_ORBITAL_RADAR","BUG_ORBITAL_RADAR_ADVANCED","BUG_FIGHTER","BUG_FIGHTER_ADVANCED","MEDUSA","STHENO",
			"BUG_AIR_FAB","BUG_AIR_FAB_ADVANCED","HARPY","BASILISK","FORAGER","FORAGER_CHEAP","CRUSHER","HYDRA","BOMBARDIER","BUG_BOT_FAB","ZAPPER","TEMPEST","BUG_BOT_FAB_ADVANCED","BELCHER","BOOMER","BOOMER_R","ALPHA_BOOMER","STEALTH_RIPPER",
			"RIPPER","RUNNER","SCORCHER","GRUNT_BIG","NEEDLER","NEEDLER_FAST","MANTICORE","BUG_SNIPER","GRUNT"
		],
